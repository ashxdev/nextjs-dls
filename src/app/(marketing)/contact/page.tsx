...
export const metadata: Metadata = {
  title: 'Контакти',
  description: 'Дізнайтеся, як нас знайти, та отримайте інформацію про наші послуги та розклад занять. Dance Line Studio: перша справді сучасна студія танців в Ужгороді. Танці для всіх: хіп-хоп, хай хілс, кей-поп, соціальні танці, бачата, контемпорарі.',
}
